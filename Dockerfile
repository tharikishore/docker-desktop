...
MAINTAINER Harikishore Tadigotla "harikishore@vivasa.in"
...
#RUN apt-get install -y xpra rox-filer openssh-server pwgen xserver-xephyr xvfb sudo
RUN apt-get install -y rox-filer openssh-server pwgen sudo
